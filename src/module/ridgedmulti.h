...
namespace noise
{
  ...
  namespace module
  {
    ...
    constexpr double DEFAULT_RIDGED_FREQUENCY = 1.0;

    /// Default lacunarity for the noise::module::RidgedMulti noise module.
    constexpr double DEFAULT_RIDGED_LACUNARITY = 2.0;

    /// Default number of octaves for the noise::module::RidgedMulti noise
    /// module.
    constexpr int DEFAULT_RIDGED_OCTAVE_COUNT = 6;
    ...
    /// module.
    constexpr int RIDGED_MAX_OCTAVE = 30;
