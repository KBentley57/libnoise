...
namespace noise
{
  ...
  namespace module 
  {
    ...
    constexpr double DEFAULT_TURBULENCE_FREQUENCY = DEFAULT_PERLIN_FREQUENCY;

    /// Default power for the noise::module::Turbulence noise module.
    constexpr double DEFAULT_TURBULENCE_POWER = 1.0;
    ...
    constexpr int DEFAULT_TURBULENCE_SEED = DEFAULT_PERLIN_SEED;
