...
namespace noise
{
  ...
  namespace utils
  {
    ...
    constexpr int RASTER_STRIDE_BOUNDARY = 4;
    #endif
    ...
    constexpr double DEFAULT_METERS_PER_POINT = 30.0;

    /// Same as the DEFAULT_METERS_PER_POINT constant, but for us
    /// canuckleheads.
    constexpr double DEFAULT_METRES_PER_POINT = DEFAULT_METERS_PER_POINT;
