...
// module (noise::noise::module::Cache).  Each group and subgroup can be thought of
...
int main ()
{
  ...
  baseContinentDef_pe0.SetNoiseQuality (noise::NoiseQuality::QUALITY_STD);
  ...
  baseContinentDef_pe1.SetNoiseQuality (noise::NoiseQuality::QUALITY_STD);
  ...
  mountainBaseDef_rm0.SetNoiseQuality (noise::NoiseQuality::QUALITY_STD);
  ...
  mountainBaseDef_rm1.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  mountainousHigh_rm0.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  mountainousHigh_rm1.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  mountainousLow_rm0.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  mountainousLow_rm1.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  hillyTerrain_bi.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  hillyTerrain_rm.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  plainsTerrain_bi0.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  plainsTerrain_bi1.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  badlandsSand_rm.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  badlandsCliffs_pe.SetNoiseQuality (noise::NoiseQuality::QUALITY_STD);
  ...
  riverPositions_rm0.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  riverPositions_rm1.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  scaledMountainousTerrain_pe.SetNoiseQuality (noise::NoiseQuality::QUALITY_STD);
  ...
  scaledHillyTerrain_pe.SetNoiseQuality (noise::NoiseQuality::QUALITY_STD);
  ...
  continentalShelf_rm.SetNoiseQuality (noise::NoiseQuality::QUALITY_BEST);
  ...
  continentsWithBadlands_pe.SetNoiseQuality (noise::NoiseQuality::QUALITY_STD);
  ...
  double gridExtent = static_cast<double>(GRID_WIDTH);
  ...
  if (resInMeters <= 240.0) {
    noise::utils::WriterTER terrainWriter;
  ...
  int x, y;
  std::uint8_t* pLineBuffer = new std::uint8_t[GRID_WIDTH * 2];
  std::ofstream os;
  ...
  for (y = 0; y < GRID_HEIGHT; y++) {
    ...
    for (x = 0; x < GRID_WIDTH; x++) {
      std::int16_t elev{ static_cast<std::int16_t>(std::floor (*pSource)) };
      *pDest++ = static_cast<std::uint8_t>(((std::uint16_t)elev & 0xff00) >> 8);
      *pDest++ = static_cast<std::uint8_t>(((std::uint16_t)elev & 0x00ff)     );
      ++pSource;
    }
  ...
  imageRenderer.AddGradientPoint (-16384.0 + seaLevelInMeters, noise::utils::Color (  0,   0,   0, 255));
  imageRenderer.AddGradientPoint (    -256 + seaLevelInMeters, noise::utils::Color (  6,  58, 127, 255));
  imageRenderer.AddGradientPoint (    -1.0 + seaLevelInMeters, noise::utils::Color ( 14, 112, 192, 255));
  imageRenderer.AddGradientPoint (     0.0 + seaLevelInMeters, noise::utils::Color ( 70, 120,  60, 255));
  imageRenderer.AddGradientPoint (  1024.0 + seaLevelInMeters, noise::utils::Color (110, 140,  75, 255));
  imageRenderer.AddGradientPoint (  2048.0 + seaLevelInMeters, noise::utils::Color (160, 140, 111, 255));
  imageRenderer.AddGradientPoint (  3072.0 + seaLevelInMeters, noise::utils::Color (184, 163, 141, 255));
  imageRenderer.AddGradientPoint (  4096.0 + seaLevelInMeters, noise::utils::Color (255, 255, 255, 255));
  imageRenderer.AddGradientPoint (  6144.0 + seaLevelInMeters, noise::utils::Color (128, 255, 255, 255));
  imageRenderer.AddGradientPoint ( 16384.0 + seaLevelInMeters, noise::utils::Color (  0,   0, 255, 255));
  ...
  noise::utils::WriterBMP bitmapWriter;
  ...
  // time.
  noise::utils::RendererImage surfaceRenderer;
  surfaceRenderer.SetSourceNoiseMap (elevGrid);
  surfaceRenderer.SetDestImage (destImage);
  surfaceRenderer.ClearGradient ();
  surfaceRenderer.AddGradientPoint (      -16384.0 + seaLevelInMeters, noise::utils::Color (  3,  29,  63, 255));
  surfaceRenderer.AddGradientPoint (DEEP_SEA_LEVEL + seaLevelInMeters, noise::utils::Color (  3,  29,  63, 255));
  surfaceRenderer.AddGradientPoint (          -1.0 + seaLevelInMeters, noise::utils::Color (  7, 106, 127, 255));
  surfaceRenderer.AddGradientPoint (           0.0 + seaLevelInMeters, noise::utils::Color ( 62,  86,  30, 255));
  surfaceRenderer.AddGradientPoint (        1024.0 + seaLevelInMeters, noise::utils::Color ( 84,  96,  50, 255));
  surfaceRenderer.AddGradientPoint (        2048.0 + seaLevelInMeters, noise::utils::Color (130, 127,  97, 255));
  surfaceRenderer.AddGradientPoint (        3072.0 + seaLevelInMeters, noise::utils::Color (184, 163, 141, 255));
  surfaceRenderer.AddGradientPoint (        4096.0 + seaLevelInMeters, noise::utils::Color (255, 255, 255, 255));
  surfaceRenderer.AddGradientPoint (        6144.0 + seaLevelInMeters, noise::utils::Color (128, 255, 255, 255));
  surfaceRenderer.AddGradientPoint (       16384.0 + seaLevelInMeters, noise::utils::Color (  0,   0, 255, 255));
  ...
  noise::utils::RendererImage specularityRenderer;
  ...
  specularityRenderer.AddGradientPoint (MIN_ELEV              , noise::utils::Color (255, 255, 255, 255));
  specularityRenderer.AddGradientPoint (seaLevelInMeters      , noise::utils::Color (255, 255, 255, 255));
  specularityRenderer.AddGradientPoint (seaLevelInMeters + 1.0, noise::utils::Color (  0,   0,   0, 255));
  specularityRenderer.AddGradientPoint (MAX_ELEV              , noise::utils::Color (128, 128, 128, 255));
